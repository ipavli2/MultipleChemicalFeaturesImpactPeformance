...
p.m.100 <- ggplot(pca_m_analog_d100_x, aes(x=PC1, y=PC2, color = Image_Metadata)) + geom_point(size=5) + stat_ellipse(level=0.95, linetype=1) + scale_color_manual(values = c("#26bf79","#bd00be", "#80ffff", "#000080"))
